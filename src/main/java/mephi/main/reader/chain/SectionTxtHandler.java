...
import mephi.main.reader.format.SectionTxtReader;
import java.io.File;
import java.io.IOException;
import java.nio.file.Files;
import java.util.List;

public class SectionTxtHandler extends ParserHandler {

    private final SectionTxtReader reader = new SectionTxtReader();
